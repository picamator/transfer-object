 ...
 *
 * @see /tests/integration/Command/data/config/success/definition-file-hash/command.transfer.yml Definition file path.
 */
final class CommandFileHashTransfer extends AbstractTransfer
{
