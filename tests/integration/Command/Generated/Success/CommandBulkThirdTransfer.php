 ...
 *
 * @see /tests/integration/Command/data/config/success/definition-bulk-second/command.third.transfer.yml Definition file path.
 */
final class CommandBulkThirdTransfer extends AbstractTransfer
{
