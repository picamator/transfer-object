 ...
 *
 * @see /tests/integration/Command/data/config/success/definition-bulk-first/command.second.transfer.yml Definition file path.
 */
final class CommandBulkSecondTransfer extends AbstractTransfer
{
