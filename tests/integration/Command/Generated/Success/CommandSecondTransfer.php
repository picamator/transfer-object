 ...
 *
 * @see /tests/integration/Command/data/config/success/definition/command.second.transfer.yml Definition file path.
 */
final class CommandSecondTransfer extends AbstractTransfer
{
