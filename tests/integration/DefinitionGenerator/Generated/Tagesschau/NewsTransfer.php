...
final class NewsTransfer extends AbstractTransfer
{
    ...
    protected const array META_DATA = [
        self::BRANDING_IMAGE => self::BRANDING_IMAGE_INDEX,
        self::BREAKING_NEWS => self::BREAKING_NEWS_INDEX,
        self::COMMENTS => self::COMMENTS_INDEX,
        self::DATE => self::DATE_INDEX,
        self::DETAILS => self::DETAILS_INDEX,
        self::DETAILSWEB => self::DETAILSWEB_INDEX,
        self::EXTERNAL_ID => self::EXTERNAL_ID_INDEX,
        self::FIRST_SENTENCE => self::FIRST_SENTENCE_INDEX,
        self::GEOTAGS => self::GEOTAGS_INDEX,
        self::REGION_ID => self::REGION_ID_INDEX,
        self::REGION_IDS => self::REGION_IDS_INDEX,
        self::RESSORT => self::RESSORT_INDEX,
        self::SHARE_U_R_L => self::SHARE_U_R_L_INDEX,
        self::SOPHORA_ID => self::SOPHORA_ID_INDEX,
        self::TAGS => self::TAGS_INDEX,
        self::TEASER_IMAGE => self::TEASER_IMAGE_INDEX,
        self::TITLE => self::TITLE_INDEX,
        self::TOPLINE => self::TOPLINE_INDEX,
        self::TRACKING => self::TRACKING_INDEX,
        self::TYPE => self::TYPE_INDEX,
        self::UPDATE_CHECK_URL => self::UPDATE_CHECK_URL_INDEX,
    ];
