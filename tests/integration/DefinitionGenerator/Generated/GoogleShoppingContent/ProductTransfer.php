...
final class ProductTransfer extends AbstractTransfer
{
    ...
    public ?string $ageGroup {
        get => $this->getData(self::AGE_GROUP_DATA_INDEX, false);
    ...
    public ?string $availability {
        get => $this->getData(self::AVAILABILITY_DATA_INDEX, false);
    ...
    public ?string $availabilityDate {
        get => $this->getData(self::AVAILABILITY_DATE_DATA_INDEX, false);
    ...
    public ?string $brand {
        get => $this->getData(self::BRAND_DATA_INDEX, false);
    ...
    public ?string $channel {
        get => $this->getData(self::CHANNEL_DATA_INDEX, false);
    ...
    public ?string $color {
        get => $this->getData(self::COLOR_DATA_INDEX, false);
    ...
    public ?string $condition {
        get => $this->getData(self::CONDITION_DATA_INDEX, false);
    ...
    public ?string $contentLanguage {
        get => $this->getData(self::CONTENT_LANGUAGE_DATA_INDEX, false);
    ...
    public ?string $feedLabel {
        get => $this->getData(self::FEED_LABEL_DATA_INDEX, false);
    ...
    public ?string $gender {
        get => $this->getData(self::GENDER_DATA_INDEX, false);
    ...
    public ?string $googleProductCategory {
        get => $this->getData(self::GOOGLE_PRODUCT_CATEGORY_DATA_INDEX, false);
    ...
    public ?string $gtin {
        get => $this->getData(self::GTIN_DATA_INDEX, false);
    ...
    public ?string $imageLink {
        get => $this->getData(self::IMAGE_LINK_DATA_INDEX, false);
    ...
    public ?string $itemGroupId {
        get => $this->getData(self::ITEM_GROUP_ID_DATA_INDEX, false);
    ...
    public ?string $kind {
        get => $this->getData(self::KIND_DATA_INDEX, false);
    ...
    public ?string $link {
        get => $this->getData(self::LINK_DATA_INDEX, false);
    ...
    public ?string $mpn {
        get => $this->getData(self::MPN_DATA_INDEX, false);
    ...
    public ?string $offerId {
        get => $this->getData(self::OFFER_ID_DATA_INDEX, false);
    ...
    public array $sizes {
        get => $this->getData(self::SIZES_DATA_INDEX, true);
    ...
    public ?string $source {
        get => $this->getData(self::SOURCE_DATA_INDEX, false);
    ...
    public ?string $targetCountry {
        get => $this->getData(self::TARGET_COUNTRY_DATA_INDEX, false);
