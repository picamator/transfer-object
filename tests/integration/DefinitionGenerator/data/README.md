...
| [frankfurter-dev-v1.json](/tests/integration/DefinitionGenerator/data/api-response/frankfurter-dev-v1.json)                     | [Frankfurter – open-source currency data API](https://api.frankfurter.dev/v1/latest)                                 |
