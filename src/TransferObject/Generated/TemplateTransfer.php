...
final class TemplateTransfer extends AbstractTransfer
{
    ...
    public ?array $attributes {
        get => $this->data[self::ATTRIBUTES_DATA_INDEX] ?? [];
    ...
    public ?array $dockBlocks {
        get => $this->data[self::DOCK_BLOCKS_DATA_INDEX] ?? [];
    ...
    public ?array $imports {
        get => $this->data[self::IMPORTS_DATA_INDEX] ?? [];
    ...
    public ?array $metaConstants {
        get => $this->data[self::META_CONSTANTS_DATA_INDEX] ?? [];
    ...
    public ?array $properties {
        get => $this->data[self::PROPERTIES_DATA_INDEX] ?? [];
